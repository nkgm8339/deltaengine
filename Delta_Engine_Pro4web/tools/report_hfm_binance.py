...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("input", type=Path, nargs="?", default=Path("data_clone/latency/quotes.csv"))
    parser.add_argument("--output", type=Path, default=Path("data_clone/latency/report.json"))
