<#
  DeltaEngineClone 1M — isolated launcher for the DeltaEngine clone.
  ...
  is enough to start the 1M product on http://127.0.0.1:18080.
...
Write-Host "DeltaEngineClone 1M starting on http://127.0.0.1:$Port (Ctrl+C to stop)"
