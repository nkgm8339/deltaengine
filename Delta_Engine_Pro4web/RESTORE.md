...
- ブラウザで http://127.0.0.1:18080 が開く。
- 動作確認: `Invoke-WebRequest http://127.0.0.1:18080/health` が `{"status":"ok"}` を返せば成功。
...
| 観測の生ログ（data_clone/execution_costs, data_clone/latency 等） | ❌ | 再生成される記録 |
