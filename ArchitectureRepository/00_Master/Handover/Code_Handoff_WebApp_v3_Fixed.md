この1ファイルに必要文書3点を全て収録済み。これだけをCodeに渡し「実行しろ。GO」と言えばよい。
...
body{background:var(--bg);color:var(--text);overflow:auto;
...
#appgrid{display:flex;flex-direction:column;gap:6px;height:100vh;min-width:1180px;min-height:640px;padding:6px}
...
.dash{color:var(--dis)}
/* top bar */
#topbar{display:flex;align-items:center;gap:18px;padding:0 16px;height:48px;flex-shrink:0;white-space:nowrap;overflow:hidden}
#price{font-size:22px;font-weight:700;line-height:48px;flex-shrink:0}
...
.fp-price{width:110px;flex-shrink:0;display:flex;align-items:center;gap:5px;color:var(--sub)}
...
.fp-delta{width:60px;flex-shrink:0;text-align:right;font-weight:600}
.fp-sig{width:44px;flex-shrink:0;text-align:center;font-size:11px}
...
function renderTop(){
  ...
  if(S.firstOpen==null)S.firstOpen=S.price;
...
```json
{ "open_interest": "84213.550", "prev": "84190.120" }
```
